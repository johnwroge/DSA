...
The product of these 4 numbers is 26 63 78 14 = 1788696
.
...
for i, List in enumerate(grid):
    grid[i] = [int(num) for num in List]
...
def find_products(grid):
    max_product = 0
    for line in grid:
        l, prod = 0, math.prod(line[:3])
