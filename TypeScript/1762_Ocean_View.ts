...
var findBuildings = function (heights: Array<number>) {
  let curr = 0;
...
console.log(findBuildings([4, 2, 3, 1])); // Expected output: [0, 2, 3]
console.log(findBuildings([4, 3, 2, 1])); // Expected output: [0, 1, 2, 3]
console.log(findBuildings([1, 3, 2, 4])); // Expected output: [3]
console.log(findBuildings([2, 2, 2, 2])); // Expected output: [3]
console.log(findBuildings([1])); // Expected output: [0]
